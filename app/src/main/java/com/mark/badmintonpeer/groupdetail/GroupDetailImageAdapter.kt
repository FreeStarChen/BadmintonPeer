...
import com.mark.badmintonpeer.databinding.GroupDetailImageBinding

class GroupDetailImageAdapter :
    RecyclerView.Adapter<GroupDetailImageAdapter.ImageViewHolder>() {
    ...
    class ImageViewHolder(private var binding: GroupDetailImageBinding) :
        ...
        fun bind(context: Context,imageUrl: String) {
            imageUrl.let {
                ...
                binding.imageGroupDetail.layoutParams = ConstraintLayout.LayoutParams(
                    displayMetrics.widthPixels,
                    context.resources.getDimensionPixelSize(R.dimen.height_detail_image)
                )
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageViewHolder {
        ...
        return ImageViewHolder(
            GroupDetailImageBinding.inflate(
